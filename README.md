...
5. Remove the `draft` line (or set it to `false`) and push to `main`. The article then appears on the homepage "Latest Articles" section (newest three), on `/blog`, and in the sitemap automatically.
