...
| FERS Basic Annuity Calculator | `/calculator/fers-annuity` | `src/lib/fersAnnuity.ts` (formula, eligibility, MRA+10 reduction and postponement, VERA/discontinued service, survivor election); tests: `npm run test:fers-annuity`; covers immediate retirement only — deferred and disability retirement are in [Issue #3](https://github.com/matanov/finportal/issues/3) |
